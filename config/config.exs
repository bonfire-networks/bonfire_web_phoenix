...
secret_key_base =
  System.get_env(
    "SECRET_KEY_BASE",
    "g7K250qlSxhNDt5qnV6f4HFnyoD7fGUuZ8tbBF69aJCOvUIF8P0U7wnnzTqklK10"
  )

config :bonfire_web_phoenix, :signing_salt, signing_salt
config :bonfire_web_phoenix, :encryption_salt, encryption_salt
# change me
config :bonfire_web_phoenix, :routes_module, Bonfire.WebPhoenix.FallbackRoutes
# change me
...
config :bonfire_web_phoenix, Bonfire.WebPhoenix.Endpoint,
  ...
  render_errors: [
    view: Bonfire.WebPhoenix.ErrorView,
    accepts: ~w(html json),
    layout: false
  ],
